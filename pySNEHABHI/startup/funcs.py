...
async def autopilot():
    ...
    try:
        r = await ultroid_bot(
            CreateChannelRequest(
                title="My Snehabhi Logs",
                about="My Ultroid Log Group\n\n Join @snehabhi_updates",
                megagroup=True,
            ),
        )
    ...
    photo = await download_file(
        "https://telegra.ph/file/5c1bd95f066aad81df745.png", "channelphoto.jpg"
    )
...
async def customize():
    ...
    try:
        ...
        await ultroid_bot.send_message(
            "botfather",
            f"✨ PowerFul Snehabhi Assistant Bot ✨\n✨ Master ~ {sir} ✨\n\n✨ Powered By ~ @snehabhi_updates ✨",
        )
        await asyncio.sleep(2)
        await ultroid_bot.send_message(
        ...
        try:
            ...
            async for x in ultroid_bot.iter_messages(
                ...
                try:
                    ...
                    LOGS.info(f"Snehabhi - PLUGIN_CHANNEL - ERROR - {plugin}")
                    LOGS.exception(e)
                    os.remove(file)
        except Exception as e:
            LOGS.exception(e)
...
async def ready():
    ...
    if not udB.get("INIT_DEPLOY"):  # Detailed Message at Initial Deploy
        MSG = """🎇 **Thanks for Deploying Snehabhi Userbot!**
• Here, are the Some Basic stuff from, where you can Know, about its Usage."""
        PHOTO = "https://telegra.ph/file/bc6ecaac6eb57cb10342c.jpg"
        BTTS = Button.inline("• Click to Start •", "initft_2")
        udB.set("INIT_DEPLOY", "Done")
    else:
        MSG = f"**Snehabhi has been deployed!**\n➖➖➖➖➖➖➖➖➖\n**UserMode**: [{ultroid_bot.me.first_name}](tg://user?id={ultroid_bot.me.id})\n**Assistant**: @{asst.me.username}\n➖➖➖➖➖➖➖➖➖\n**Support**: @snehabhi_updates\n➖➖➖➖➖➖➖➖➖"
    ...
    try:
        ...
        await ultroid_bot(JoinChannelRequest("@snehabhi_server"))
    except ChannelsTooMuchError:
        LOGS.info("Join @snehabhi_updates to know about new Updates...")
